...
#include "textures/segment2/hud-coin-custom.rgba16.inc.c"
};

ALIGNED8 static const Texture texture_hud_char_mario_head[] = {
#include "textures/segment2/hud-head-custom.rgba16.inc.c"
};

ALIGNED8 static const Texture texture_hud_char_star[] = {
#include "textures/segment2/hud-star-custom.rgba16.inc.c"
};
